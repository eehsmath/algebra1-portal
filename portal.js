...
(function () {
  ...
  var REGISTRY = [
    ...
    { sec: 'linear', id: 'A.2', code: 'A.2', short: 'Linear equations & systems',
    ...
    { sec: 'linear', id: 'A.3', code: 'A.3', short: 'Graphing linear functions',
    ...
    { sec: 'linear', id: 'A.4', code: 'A.4', short: 'Statistical relationships',
    ...
    { sec: 'linear', id: 'A.5', code: 'A.5', short: 'Solving linear equations',
    ...
    { sec: 'quadratic', id: 'A.6', code: 'A.6', short: 'Writing quadratic equations',
      name: 'Write and represent quadratic equations.',
      file: 'apps/teks-a6.html', status: 'ready',
      modules: ['A.6A','A.6B','A.6C'] },
    { sec: 'quadratic', id: 'A.7', code: 'A.7', short: 'Graphing quadratic functions',
    ...
    { sec: 'quadratic', id: 'A.8', code: 'A.8', short: 'Solving quadratic equations',
    ...
    { sec: 'exponential', id: 'A.9', code: 'A.9', short: 'Exponential equations & graphs',
    ...
    { sec: 'methods', id: 'A.10', code: 'A.10', short: 'Polynomial expressions',
    ...
    { sec: 'methods', id: 'A.11', code: 'A.11', short: 'Equivalent expressions',
      name: 'Rewrite algebraic expressions into equivalent forms.',
      file: 'apps/teks-a11.html', status: 'ready',
      modules: ['A.11A','A.11B'] },
    { sec: 'methods', id: 'A.12', code: 'A.12', short: 'Equations, relations & functions',
